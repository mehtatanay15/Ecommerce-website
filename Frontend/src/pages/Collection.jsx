    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 border-t pt-10 ">
      ...
      <div className="min-w-60">
        <p
          ...
          className="my-2 text-xl gap-2 flex items-center cursor-pointer"
        >
          filters
          <img
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={"children"} />
              children
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={"top-wear"} />
              top-wear
            </p>
